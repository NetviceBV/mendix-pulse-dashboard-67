-- Insert A10 OWASP step linking to the new edge function
INSERT INTO public.owasp_steps (user_id, owasp_item_id, step_name, step_description, edge_function_name, step_order, is_active)
SELECT 
  oi.user_id,
  oi.id,
  'A10 Manual URL Verification',
  'Manual verification for Server-Side Request Forgery (SSRF) prevention URLs',
...
-- Update the initialize_edge_functions function to include A10
