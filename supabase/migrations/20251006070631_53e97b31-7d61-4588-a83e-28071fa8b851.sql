-- Update initialize_edge_functions to include the new orchestrator
...
COMMENT ON FUNCTION public.initialize_edge_functions IS 
'Initializes or updates edge function metadata for a user. Orchestrator-based checks provide significant performance improvements by batching domain model access.';